(() => {
    ...
    function menuInit() {
        if (document.querySelector(".menu__btn")) document.addEventListener("click", (function(e) {
    ...
    function videoYoutube() {
        ...
        function iframeGenerate(videoId) {
            const iframe = document.createElement("iframe"), src = `https://www.youtube.com/embed/${videoId}?rel=0&showinfo=0&autoplay=1`;
    ...
    function initSliders() {
        if (document.querySelector(".hero__body")) new Swiper(".hero__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-button-hero.swiper-button-prev",
                nextEl: ".swiper-button-hero.swiper-button-next"
            },
            breakpoints: {
                320: {
                    spaceBetween: 60,
        ...
        if (document.querySelector(".models__body")) new Swiper(".models__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-button-models.swiper-button-prev",
                nextEl: ".swiper-button-models.swiper-button-next"
            },
            breakpoints: {
                320: {
                    spaceBetween: 60,
        ...
        if (document.querySelector(".variety__body")) new Swiper(".variety__body", {
            modules: [ Scrollbar ],
            observer: true,
            observeParents: true,
            speed: 800,
        ...
        if (document.querySelector(".cases__body")) new Swiper(".cases__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-button-cases.swiper-button-prev",
                nextEl: ".swiper-button-cases.swiper-button-next"
            },
            breakpoints: {
                320: {
                    spaceBetween: 60,
        ...
        if (document.querySelector(".gallery__body")) new Swiper(".gallery__body", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest(".circle-btn")) {
            const activeSlide = targetElement.parentNode, imgDecHero = document.querySelector(".hero__dec");
            activeSlide.classList.toggle("active-slide");
            imgDecHero.classList.toggle("active-img");
        }
        if (targetElement.closest(".swiper-button-hero")) {
            const imgActive = document.querySelector(".active-img"), slideActive = document.querySelector(".active-slide");
            imgActive ? imgActive.classList.remove("active-img") : null;
            slideActive ? slideActive.classList.remove("active-slide") : null;
        }
    }
    if (document.querySelector("[data-dark]")) {
        const header = document.querySelector("header");
        const watcherElements = document.querySelectorAll("[data-dark]");
        ...
        const observer = new IntersectionObserver((entries => {
            entries.forEach((entry => {
                if (entry.isIntersecting) header.classList.add("_dark-theme"); else {
                    const allIntersecting = Array.from(entries).some((e => e.isIntersecting));
                    if (!allIntersecting) header.classList.remove("_dark-theme");
                }
            }));
        }), observerOptions);
